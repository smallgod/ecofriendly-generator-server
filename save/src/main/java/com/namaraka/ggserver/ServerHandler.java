...
public class ServerHandler {
    ...
    Handler getWebAppContextHandlerStaging() {
        ...
        WebAppContext webAppHandler = new WebAppContext();
            ...
            // webAppHandler.setWar(ApplicationPropertyLoader.loadInstance().getJarFolderName() + "/src/main/ggserver/war/ggserver.war");
            // webAppHandler.setResourceBase("/home/smallgod/NetBeansProjects/ggserver/src/main/ggserver/"); //get app dir variable location
            // webAppHandler.setDescriptor("/home/smallgod/NetBeansProjects/src/main/ggserver/WEB-INF/web.xml");
             
             webAppHandler.setResourceBase(ApplicationPropertyLoader.loadInstance().getJarFolderName() + "/src/main/ggserver/"); //get app dir variable location
             webAppHandler.setDescriptor(ApplicationPropertyLoader.loadInstance().getJarFolderName() + "/src/main/ggserver/WEB-INF/web.xml");

//jarFolder: /srv/applications/ggserver
//ConfigsFolder: /etc/ug/ggserver/appfiles/config/development/
        
        
        
            // webAppHandler.setDefaultDescriptor(ApplicationPropertyLoader.loadInstance().getJarFolderName() + "/src/main/ggserver/webdefault/webdefault.xml"); //copy from The location is JETTY_HOME/etc/webdefault.xml     
